...
def construct_landmark_file(atl_points, sub_points, atl_landmark, sub_landmark):
  ...
  #print("maxx-minx: {}".format(maxx-minx))
  #print("maxy-miny: {}".format(maxy-miny))
  #print("maxz-minz: {}".format(maxz-minz))
...
atl_pts = r'I:\00.masterarbeit_dataset\04.LRV-ALL_Dataset-Affine_Registered\xx.Good_Bad_Random\tiff\scaled-np-channel\tiff\bc_corrected\atlas_points\np_atlas_scaled_pixel.points'
